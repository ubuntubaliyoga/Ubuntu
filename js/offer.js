...
function buildOfferHTML(){
  ...
  }<div class="e-invest-grand"><span class="e-invest-grand-lbl">Total Investment</span><span class="e-invest-grand-val">USD ${fmtN(hasExtras?grandIn:P.totalIn,0)}</span></div><div class="e-invest-note">excl. tax &amp; service charges &nbsp;·&nbsp; USD ${fmtN(hasExtras?grandEx:P.totalEx,0)}</div></div>`:'';
