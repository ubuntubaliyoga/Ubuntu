...
async function saveToNotion(silent=false){
  if(window._templateMode||window._contractTemplateMode){if(!silent)showTemplateConfirm();return;}
  const btn=$('save-btn');
