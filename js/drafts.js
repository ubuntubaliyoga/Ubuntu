...
function printOffer(){
  const pageStyles=`@page{size:A4 portrait;margin:12mm 15mm;}*{-webkit-print-color-adjust:exact;print-color-adjust:exact;}.c-sec{page-break-inside:avoid;}.c-table{page-break-inside:avoid;}.c-parties{page-break-inside:avoid;}`;
