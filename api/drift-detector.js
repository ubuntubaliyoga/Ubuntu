...
const EXPECTED = [
  ...
  {
    id:     '8e5622d3e57482ba950081ac7695672e',
    label:  'Email CRM',
    source: 'api/crm.js',
    props: {
      'Name':                   'title',
      ...
      'Engaged last':           'date',
      'Engage Next':            'date',
      'Sales Call Booked Date': 'date',
    },
  },
  {
    id:     '320622d3e5748066b6dfcea95816fad2',
    label:  'WhatsApp CRM',
    source: 'api/crm.js',
    props: {
      'Name':                         'title',
      ...
      'Insta':                        'rich_text',
      'Website':                      'rich_text',
      'Whatsapp 1':                   'rich_text',
      'Whatsapp 2':                   'rich_text',
      'Notes':                        'rich_text',
      'Multi-select':                 'select',
      'Suitability':                  'select',
      'Engaged first':                'rich_text',
      'Engage Next':                  'date',
      'Sales Call/Visit Booked Date': 'date',
    },
  },
  {
    id:     '320622d3e57480608324f0eb4d3b8a2c',
    label:  'Shala CRM',
    source: 'api/crm.js',
    props: {
      'Name':                         'title',
  ...
  {
    id:     '325622d3e57481bbbaaedeb47e377f2c',
    label:  'Converted CRM',
    source: 'api/crm.js',
    props: {
      'Name':                         'title',
